...
#Barclay Bicksler,11-23-2020,Modified code to complete assignment 6
#Barcly Bicksler,11-24-2020, Continued work to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        row = {"Task": task, "Priority": priority}  # adding new user input values to the dicRow keys
        list_of_rows.append(row)
        return list_of_rows, 'Success'
...
class IO:
    ...
    def input_task_to_remove():
        task = input("Enter the task you wish to remove: ").lower().strip()
        print()
        return task
